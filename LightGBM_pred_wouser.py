...
def predict_pipeline():
    ...
    feature_path = './features/weibo_bert_features_predict_32.csv'
    output_dir = './save'
    ...
    try:
        ...
        # 加载其他特征
        df_time = pd.read_csv('./features/predict_time_features.csv')
        df_text1 = pd.read_csv('./features/predict_text_features.csv')
        df_text2 = pd.read_csv('./features/predict_text_features2.csv')
        ...
        X_pred = pd.merge(merged_df, df_text2, on=['uid', 'mid'], how='inner')
