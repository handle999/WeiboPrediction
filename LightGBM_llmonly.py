...
def load_and_process_data(feature_path, train_path):
    ...
    df_features = pd.concat([df_features[['uid', 'mid']], content_features], axis=1)
...
def train_and_predict(merged_df):
    ...
    X = merged_df[[f'feature_{i}' for i in range(32)]]
            ...
            with redirect_stdout(log_file):
                ...
                def objective(trial):
                    params = {
                        ...
                        'n_estimators': 2000,  # 使用早停决定实际迭代次数
                    }
...
if __name__ == '__main__':
    feature_path = './features/weibo_qwen3_features_train_32.csv'
